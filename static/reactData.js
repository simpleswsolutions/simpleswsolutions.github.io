...
(function (global) {
    ...
    var costsData = {
        ...
        title: 'React JS Web Application Project effort estimation',
        ...
        sections: [
            ...
            },
            {
                ...
                description: 'Please select the framework that closest describes your project.',
                items: [
                    {
                        name: 'phoneGap',
                        label: 'PhoneGap',
                        description: 'Application will be bundled with PhoneGap',
                    ...
                    },
                    {
                        ...
                        label: 'Material UI',
                        description: '',
                        type: 2, // 0=Input, 1=CB, 2=RB, 3=Dropdown
                        defaultValue: true
                    },
                    {
                        name: 'bootstrap',
                ...
                items: [
                    {
                        name: 'screens',
                        label: 'Details pages',
                        description: 'Simple pages that display information',
                        type: 3, // 3=Dropdown
                    ...
                    {
                        name: 'inputScreens',
                        label: 'Input data pages',
                        description: 'Pages that collect data from the user',
                        type: 3, // 3=Dropdown
                        values: [1, 3, 5, 10, 15, 20],
                        defaultValue: 3
                    },
                    {
                        name: 'editScreens',
                        label: 'Data editing pages',
                        description: 'Pages to edit existign data, forms',
                        type: 3, // 3=Dropdown
                        values: [1, 3, 5, 10, 15, 20],
                        defaultValue: 3
                    },
            ...
            },
            {
                ...
                description: 'Use this section to more finely specify pickers and components required by the' +
                ...
                items: [
                    ...
                    },
                    {
                        ...
                        label: 'Simple Custom Components',
                        description: 'Relatively simple user components',
                        type: 3, // 3=Dropdown
                        values: [0, 1, 3, 5, 10, 15, 20],
                        defaultValue: 3
                    },
                    {
                        ...
                        label: 'Advanced Custom Components',
                        description: 'User components of higher complexity',
                        type: 3, // 3=Dropdown
                        values: [0, 1, 3, 5, 10, 15, 20],
                        defaultValue: 1
                    },
                    {
                        name: 'sliderControls',
                        label: 'Slider Components',
                        description: 'Slider components in app',
                        type: 3, // 3=Dropdown
                        values: [0, 1, 3, 5, 10, 15, 20],
                        defaultValue: 0
                    }
